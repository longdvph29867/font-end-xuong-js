...
const AdminUsersAdd = () => {
    ...
    useEffect(() => {
        ...
        formAdd.addEventListener('submit', function (e) {
            ...
            console.log("🚀 ~ file: users-add.js:114 ~ addData:", addData)
            if(isVali) {
    
                showSpinner();
                dataService.postUserAdd(addData)
                .then((res) => {
                    // console.log(res);
        ...
        <div class="grow p-6">
            <div class="bg-white h-full">
                <div class="p-5 max-w-md mx-auto">
                    <h3 class="font-medium text-green-500 text-2xl text-center mb-4">Thêm mới người dùng</h3>
                    <form id='form-add'>
                        <div class="mb-2">
