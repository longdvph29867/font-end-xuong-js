            ...
            if(categoryName.length == 0){
                ...
                .then((res)=>{
                    ...
                    for(const item of category){
                        if(item.categorieName.toLowerCase() === categoryName.toLowerCase()){
                            document.querySelector('#error-name').innerText = "Danh mục đã tồn tại";
                            break;
                        }else{
                            isValiName = true;
                        }
                ...
                <div class="p-5 max-w-md mx-auto">
                    ...
                    <form id="creatCategorys-form">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" name="name-category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
