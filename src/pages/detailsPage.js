...
const DetailsPage = (data) => {
  ...
  return /*html*/ `
    ${Header()}
      ...
      <div class="my-12">
      <div>
        <div class="max-w-5xl mx-auto flex md:grid md:grid-cols-2 gap-5">
            <div class="w-max md:w-full">
                <div class="relative">
                    ...
                    <img id="img_show" class="mx-auto h-72 md:h-96" src="${
                      isProducts.image
                    }" alt="">
            ...
            <div>
                <h2 class="font-medium xl:text-xl">${isProducts.productName}</h2>
                ...
                <div class="flex my-5">
                    ...
                    <ul class="flex gap-5">
                        <li class="relative">
                            ...
                            <label class="size bg-white px-3 sm:px-4 sm:py-1 border-2" for="S">S</label>
                        </li>
                        <li class="relative">
                            <input class="absolute -z-10" type="radio" value="" name="size" id="M">
                            <label class="size bg-white px-3 sm:px-4 sm:py-1 border-2" for="M">M</label>
                        </li>
                        <li class="relative">
                            <input class="absolute -z-10" type="radio" value="" name="size" id="L">
                            <label class="size bg-white px-3 sm:px-4 sm:py-1 border-2" for="L">L</label>
                        </li>
                        <li class="relative">
                            <input class="absolute -z-10" type="radio" value="" name="size" id="XL">
                            <label class="size bg-white px-3 sm:px-4 sm:py-1 border-2" for="XL">XL</label>
                        </li>
                    </ul>
                </div>
                <div class="flex my-5">
                ...
                <div>
                    ...
                    <div class="border w-max inline-block">
                        <button id="minus" class="bg-white outline-none px-2 py-3 mr-2 lg:mr-3">-</button>
                        <input class="w-6 text-center" id="amount" type="number" value="1">
                        <button id="plus" class="bg-white outline-none px-2 py-3 mr-2 lg:ml-3">+</button>
                    </div>
                    <div class="inline-block mt-3 sm:mt-0">
                        <button class="bg-black px-6 h-12 text-white rounded-lg hover:bg-[#ECAF82] duration-300">
    ...
    <!-- review and feedback -->
    <div class="mt-5 px-3">
        <div class="max-w-5xl h-max sm:max-h-[460px] mx-auto sm:grid grid-cols-2 gap-5">
            <!-- review -->
            <div class="border rounded-lg p-5 max-h-[460px] sm:h-auto">
            ...
            <!-- feedback -->
            <div class="border rounded-lg mt-3 sm:mt-0 h-80 p-5">
                ...
                <div class="pt-3 mt-3 border-t-2">
                    <form action="">
                        ...
                        <button class="w-24 h-10 border font-medium 
